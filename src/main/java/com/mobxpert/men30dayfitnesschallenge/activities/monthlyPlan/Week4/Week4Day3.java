...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week4.Week4Day3Adapter;
...
public class Week4Day3 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week4Day3Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek4Day3Workout(Week4Day3.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek4Day3Workout(Week4Day3.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week4Day3Adapter(Week4Day3.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week4Day3.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week4Day3", result);
        return result;
