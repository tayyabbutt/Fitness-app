...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week4.Week4Day5Adapter;
...
public class Week4Day5  extends AppCompatActivity {
    RecyclerView recycler_view;
    Week4Day5Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek4Day5Workout(Week4Day5.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek4Day5Workout(Week4Day5.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week4Day5Adapter(Week4Day5.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week4Day5.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week4Day5", result);
        return result;
