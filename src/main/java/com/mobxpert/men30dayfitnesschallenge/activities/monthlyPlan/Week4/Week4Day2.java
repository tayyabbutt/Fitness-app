...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week4.Week4Day2Adapter;
...
public class Week4Day2 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week4Day2Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek4Day2Workout(Week4Day2.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek4Day2Workout(Week4Day2.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week4Day2Adapter(Week4Day2.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week4Day2.this, YouTubePlayerActivity.class);
 ...
 */
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week4Day2", result);
        return result;
