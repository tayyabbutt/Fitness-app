...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week1.LegsDayAdapter;
...
public class LegsDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek1Day6Workout(LegsDay.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek1Day6Workout(LegsDay.this);
    ...
    private void setAdapter() {
        ...
        adapter = new LegsDayAdapter(LegsDay.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(LegsDay.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week1Day6", result);
        return result;
