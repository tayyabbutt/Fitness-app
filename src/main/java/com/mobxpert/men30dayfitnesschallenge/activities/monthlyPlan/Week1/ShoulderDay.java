...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week1.ShoulderDayAdapter;
...
public class ShoulderDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek1Day5Workout(ShoulderDay.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek1Day5Workout(ShoulderDay.this);
    ...
    private void setAdapter() {
        ...
        adapter = new ShoulderDayAdapter(ShoulderDay.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(ShoulderDay.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week1Day5", result);
        return result;
