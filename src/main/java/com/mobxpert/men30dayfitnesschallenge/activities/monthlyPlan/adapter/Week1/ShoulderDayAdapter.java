package com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week1;
...
public class ShoulderDayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ShoulderDayAdapter(Context context, List<MyWorkout> myWorkoutList, int itemPosition, boolean isExerciseDone, OnMyWorkoutClickListner onMyWorkoutClickListner) {
    ...
    private void bindBodyComponent(MyViewHolder holder, final int position) {
        ...
        if (isExerciseDone == true && itemPosition == position) {
            ...
            MyDbPrefrences.saveWeek1Day5Workout(context, myWorkoutList);
