...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week2.Week2Day4Adapter;
...
public class AbsDayWeek2Day4 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week2Day4Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek2Day4Workout(AbsDayWeek2Day4.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek2Day4Workout(AbsDayWeek2Day4.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week2Day4Adapter(AbsDayWeek2Day4.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(AbsDayWeek2Day4.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week2Day4", result);
        return result;
