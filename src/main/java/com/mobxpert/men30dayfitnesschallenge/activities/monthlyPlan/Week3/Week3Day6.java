...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week3.Week3Day6Adapter;
...
public class Week3Day6 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week3Day6Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek3Day6Workout(Week3Day6.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek3Day6Workout(Week3Day6.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week3Day6Adapter(Week3Day6.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week3Day6.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week3Day6", result);
        return result;
