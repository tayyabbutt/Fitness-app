...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week2.Week2Day3Adapter;
...
public class Week2Day3 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week2Day3Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek2Day3Workout(Week2Day3.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek2Day3Workout(Week2Day3.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week2Day3Adapter(Week2Day3.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week2Day3.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week2Day3", result);
        return result;
