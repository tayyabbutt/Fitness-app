...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week2.Week2Day5Adapter;
...
public class Week2Day5 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week2Day5Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek2Day5Workout(Week2Day5.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek2Day5Workout(Week2Day5.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week2Day5Adapter(Week2Day5.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week2Day5.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week2Day5", result);
        return result;
