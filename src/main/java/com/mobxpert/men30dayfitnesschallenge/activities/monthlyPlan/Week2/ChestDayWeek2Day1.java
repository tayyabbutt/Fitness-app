package com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.Week2;
...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week2.Week2Day1Adapter;
...
public class ChestDayWeek2Day1 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week2Day1Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek2Day1Workout(ChestDayWeek2Day1.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek2Day1Workout(ChestDayWeek2Day1.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week2Day1Adapter(ChestDayWeek2Day1.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(ChestDayWeek2Day1.this, YouTubePlayerActivity.class);
 ...
 */
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week2Day1", result);
        return result;
