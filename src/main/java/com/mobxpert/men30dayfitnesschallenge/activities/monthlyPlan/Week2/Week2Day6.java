...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week2.Week2Day6Adapter;
...
public class Week2Day6 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week2Day6Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek2Day6Workout(Week2Day6.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek2Day6Workout(Week2Day6.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week2Day6Adapter(Week2Day6.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week2Day6.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week2Day6", result);
        return result;
