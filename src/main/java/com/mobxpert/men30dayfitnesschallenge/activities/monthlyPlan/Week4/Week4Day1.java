...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week4.Week4Day1Adapter;
...
public class Week4Day1 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week4Day1Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek4Day1Workout(Week4Day1.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek4Day1Workout(Week4Day1.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week4Day1Adapter(Week4Day1.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week4Day1.this, YouTubePlayerActivity.class);
 ...
 */
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week4Day1", result);
        return result;
