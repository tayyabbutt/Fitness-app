...
public class WingsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WingsAdapter(Context context, List<MyWorkout> myWorkoutList, int itemPosition, boolean isExerciseDone, OnMyWorkoutClickListner onMyWorkoutClickListner) {
...
*/
        if (isExerciseDone == true && itemPosition == position) {
            ...
            MyDbPrefrences.saveWeek1Day2Workout(context, myWorkoutList);
            holder.completeText.setVisibility(View.VISIBLE);
