...
public class ArmsDayAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ArmsDayAdapter(Context context, List<MyWorkout> myWorkoutList, int itemPosition, boolean isExerciseDone, OnMyWorkoutClickListner onMyWorkoutClickListner) {
    ...
    private void bindBodyComponent(MyViewHolder holder, final int position) {
        ...
        if (isExerciseDone == true && itemPosition == position) {
            ...
            MyDbPrefrences.saveWeek1Day3Workout(context, myWorkoutList);
            holder.completeText.setVisibility(View.VISIBLE);
