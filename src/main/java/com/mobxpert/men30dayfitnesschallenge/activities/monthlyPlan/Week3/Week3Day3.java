...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week3.Week3Day3Adapter;
...
public class Week3Day3 extends AppCompatActivity {
    RecyclerView recycler_view;
    Week3Day3Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek3Day3Workout(Week3Day3.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek3Day3Workout(Week3Day3.this);
    ...
    private void setAdapter() {
        ...
        adapter = new Week3Day3Adapter(Week3Day3.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(Week3Day3.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week3Day3", result);
        return result;
