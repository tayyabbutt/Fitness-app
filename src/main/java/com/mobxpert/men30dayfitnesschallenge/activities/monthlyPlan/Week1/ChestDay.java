...
import com.mobxpert.men30dayfitnesschallenge.activities.monthlyPlan.adapter.Week1.ChestDayAdapter;
...
public class ChestDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getWeek1Day1Workout(ChestDay.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWeek1Day1Workout(ChestDay.this);
    ...
    private void setAdapter() {
        ...
        adapter = new ChestDayAdapter(ChestDay.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(ChestDay.this, YouTubePlayerActivity.class);
 ...
 */
    ...
    public int getPercentageOfWeeklyWorkout(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Week1Day1", result);
        return result;
