...
import com.mobxpert.men30dayfitnesschallenge.adapter.shoulderWorkout.BackShoulderAdapter;
...
import com.mobxpert.men30dayfitnesschallenge.recyclerItemDecorator.LinearDividerItemDecoration;
...
public class BackShoulderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_back_shoulder);
        ...
        if (MyDbPrefrences.getShoulderWorkoutBackShoulder(BackShoulderActivity.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getShoulderWorkoutBackShoulder(BackShoulderActivity.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void setAdapter() {
        ...
        adapter = new BackShoulderAdapter(BackShoulderActivity.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(BackShoulderActivity.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("BackShoulder", result);
        return result;
