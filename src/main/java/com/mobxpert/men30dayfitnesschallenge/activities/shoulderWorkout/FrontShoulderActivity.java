...
import com.mobxpert.men30dayfitnesschallenge.adapter.shoulderWorkout.FrontShoulderAdapter;
...
public class FrontShoulderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_front_shoulder);
        ...
        if (MyDbPrefrences.getShoulderWorkoutFrontShoulder(FrontShoulderActivity.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getShoulderWorkoutFrontShoulder(FrontShoulderActivity.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void initializingList() {
        myWorkoutList.add(0, new MyWorkout(R.string.front_shoulder_exercise_1, R.string.frontShoulder, "qEwKCR5JCog",R.string.repAndSets));
        myWorkoutList.add(1, new MyWorkout(R.string.front_shoulder_exercise_2, R.string.frontShoulder, "3VcKaXpzqRo",R.string.repAndSets));
        myWorkoutList.add(2, new MyWorkout(R.string.front_shoulder_exercise_3, R.string.frontShoulder, "yfNg5sFndbw",R.string.repAndSets));
        myWorkoutList.add(3, new MyWorkout(R.string.front_shoulder_exercise_4, R.string.frontShoulder, "ECWxumBMLVQ",R.string.repAndSets));
        myWorkoutList.add(4, new MyWorkout(R.string.front_shoulder_exercise_5, R.string.frontShoulder, "X60-yTMOJfw",R.string.repAndSets));
        myWorkoutList.add(5, new MyWorkout(R.string.front_shoulder_exercise_6, R.string.frontShoulder, "-t7fuZ0KhDA",R.string.repAndSets));
    ...
    private void setAdapter() {
        ...
        adapter = new FrontShoulderAdapter(FrontShoulderActivity.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(FrontShoulderActivity.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("FrontShoulder", result);
        return result;
