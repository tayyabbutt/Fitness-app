...
public class FullScreenImageActivity extends FragmentActivity {
    ...
    ViewPager viewPager;
    public static final String[] IMAGE_NAME = {"bird1_after"};
    ...
    public static class SwipeFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            int imgResId = getResources().getIdentifier(imageFileName, "drawable", "com.softronix.healthandfitness.drawer.activities");
