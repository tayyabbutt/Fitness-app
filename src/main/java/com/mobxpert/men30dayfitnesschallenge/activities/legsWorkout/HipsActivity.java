...
import com.mobxpert.men30dayfitnesschallenge.adapter.legsWorkout.HipsAdapter;
...
public class HipsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyDbPrefrences.getLegsWorkoutHips(HipsActivity.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getLegsWorkoutHips(HipsActivity.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void initializingList() {
        myWorkoutList.add(0, new MyWorkout(R.string.hips_exercise_1, R.string.hips, "CBaDRYtLHtM", R.string.repAndSets));
        myWorkoutList.add(1, new MyWorkout(R.string.hips_exercise_2, R.string.hips, "SEdqd1n0cvg", R.string.repAndSets));
        myWorkoutList.add(2, new MyWorkout(R.string.hips_exercise_3, R.string.hips, "2C-uNgKwPLE", R.string.repAndSets));
        myWorkoutList.add(3, new MyWorkout(R.string.hips_exercise_4, R.string.hips, "YSxHifyI6s8", R.string.repAndSets));
        myWorkoutList.add(4, new MyWorkout(R.string.hips_exercise_5, R.string.hips, "29k1TypoU4w", R.string.repAndSets));
    ...
    private void setAdapter() {
        ...
        adapter = new HipsAdapter(HipsActivity.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(HipsActivity.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("Hips", result);
        return result;
