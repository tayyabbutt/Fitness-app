...
import com.mobxpert.men30dayfitnesschallenge.adapter.legsWorkout.BackThighAdapter;
...
public class BackThigsActivity extends AppCompatActivity {
    RecyclerView recycler_view;
    BackThighAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_back_thigs);
        ...
        if (MyDbPrefrences.getLegsWorkoutBackThighs(BackThigsActivity.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getLegsWorkoutBackThighs(BackThigsActivity.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void setAdapter() {
        ...
        adapter = new BackThighAdapter(BackThigsActivity.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(BackThigsActivity.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("BackThigh", result);
        return result;
