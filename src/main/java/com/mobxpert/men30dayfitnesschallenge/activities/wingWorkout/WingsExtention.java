...
import com.mobxpert.men30dayfitnesschallenge.adapter.wingsWorkout.WingsExtentionAdapter;
...
public class WingsExtention extends AppCompatActivity {
    RecyclerView recycler_view;
    WingsExtentionAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wings_extention);
        ...
        if (MyDbPrefrences.getWingsWorkoutWingsExtention(WingsExtention.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getWingsWorkoutWingsExtention(WingsExtention.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void initializingList() {
        myWorkoutList.add(0, new MyWorkout(R.string.wings_extention_exercise_1, R.string.wingExtention, "GZbfZ033f74", R.string.repAndSets));
        myWorkoutList.add(1, new MyWorkout(R.string.wings_extention_exercise_2, R.string.wingExtention, "pYcpY20QaE8", R.string.repAndSets));
        myWorkoutList.add(2, new MyWorkout(R.string.wings_extention_exercise_3, R.string.wingExtention, "tpLnfSQJ0gg", R.string.repAndSets));
        myWorkoutList.add(3, new MyWorkout(R.string.wings_extention_exercise_4, R.string.wingExtention, "NwyhyKyFgf4", R.string.repAndSets));
        myWorkoutList.add(4, new MyWorkout(R.string.wings_extention_exercise_5, R.string.wingExtention, "-xlBxIMqh3A", R.string.repAndSets));
        myWorkoutList.add(5, new MyWorkout(R.string.wings_extention_exercise_6, R.string.wingExtention, "AjCCGN2tU3Q", R.string.repAndSets));
    }
    ...
    private void setAdapter() {
        ...
        adapter = new WingsExtentionAdapter(WingsExtention.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(WingsExtention.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("WingsExtention", result);
        return result;
