...
import com.mobxpert.men30dayfitnesschallenge.adapter.absWorkout.AbsLowerAbsAdapter;
...
public class LowerAbsActivity extends AppCompatActivity {
    RecyclerView recycler_view;
    AbsLowerAbsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lower_abs);
        ...
        if (MyDbPrefrences.getAbsWorkoutLowerAbs(LowerAbsActivity.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getAbsWorkoutLowerAbs(LowerAbsActivity.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void setAdapter() {
        ...
        adapter = new AbsLowerAbsAdapter(LowerAbsActivity.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(LowerAbsActivity.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        //MyDbPrefrences.saveLowerAbsWorkoutPercentage(this, result);
        SharedPrefUtility.getInstance(this).savePrefrences("LowerAbs", result);
        return result;
