...
import com.mobxpert.men30dayfitnesschallenge.adapter.chestWorkout.MiddleChestAdapter;
...
public class MiddleChestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_middle_chest_workout);
        ...
        if (MyDbPrefrences.getChestWorkoutMiddleChest(MiddleChestActivity.this) != null) {
            myWorkoutList.clear();
            myWorkoutList = MyDbPrefrences.getChestWorkoutMiddleChest(MiddleChestActivity.this);
        } else {
            initializingList();
        }
        setAdapter();
    ...
    private void initializingList() {
        myWorkoutList.add(0, new MyWorkout(R.string.middle_chest_exercise_1,R.string.middleChest, "Qr7dstCeYtw",R.string.repAndSets));
        myWorkoutList.add(1, new MyWorkout(R.string.middle_chest_exercise_2, R.string.middleChest, "GtHNC-5GtR0",R.string.repAndSets));
        myWorkoutList.add(2, new MyWorkout(R.string.middle_chest_exercise_3, R.string.middleChest, "nEF0bv2FW94",R.string.repAndSets));
        myWorkoutList.add(3, new MyWorkout(R.string.middle_chest_exercise_4, R.string.middleChest, "eozdVDA78K0",R.string.repAndSets));
        myWorkoutList.add(4, new MyWorkout(R.string.middle_chest_exercise_5, R.string.middleChest, "WCAIi9xvNR8",R.string.repAndSets));
        myWorkoutList.add(5, new MyWorkout(R.string.middle_chest_exercise_6, R.string.middleChest, "tpLnfSQJ0gg",R.string.repAndSets));
    }
    ...
    private void setAdapter() {
        ...
        adapter = new MiddleChestAdapter(MiddleChestActivity.this, myWorkoutList, itemPosition, isExerciseDone, new OnMyWorkoutClickListner() {
            @Override
            public void onListItemClicked(int position, MyWorkout myWorkout) {
                ...
                Intent intent = new Intent(MiddleChestActivity.this, YouTubePlayerActivity.class);
    ...
    public int getPercentageOfBicepsExcercise(List<MyWorkout> workoutList) {
        ...
        SharedPrefUtility.getInstance(this).savePrefrences("MiddleChest", result);
        return result;
